...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000010647b70000000000aab6017(
...
class phpbbtemplatetwiglexer_0000000010647b70000000000aab6017 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder59d0fc8dd2071449808088 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer59d0fc8dd2084142875769 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties59d0fc8dd203b937394740 = array(
    ...
    {
        $this->initializer59d0fc8dd2084142875769 && $this->initializer59d0fc8dd2084142875769->__invoke($this->valueHolder59d0fc8dd2071449808088, $this, 'set_environment', array('env' => $env), $this->initializer59d0fc8dd2084142875769);

        return $this->valueHolder59d0fc8dd2071449808088->set_environment($env);
    }
    ...
    {
        $this->initializer59d0fc8dd2084142875769 && $this->initializer59d0fc8dd2084142875769->__invoke($this->valueHolder59d0fc8dd2071449808088, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer59d0fc8dd2084142875769);

        return $this->valueHolder59d0fc8dd2071449808088->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer59d0fc8dd2084142875769 && $this->initializer59d0fc8dd2084142875769->__invoke($this->valueHolder59d0fc8dd2071449808088, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer59d0fc8dd2084142875769);

        return $this->valueHolder59d0fc8dd2071449808088->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer59d0fc8dd2084142875769 = $initializer;
    }
    ...
    {
        $this->initializer59d0fc8dd2084142875769 && $this->initializer59d0fc8dd2084142875769->__invoke($this->valueHolder59d0fc8dd2071449808088, $this, '__get', array('name' => $name), $this->initializer59d0fc8dd2084142875769);

        if (isset(self::$publicProperties59d0fc8dd203b937394740[$name])) {
            return $this->valueHolder59d0fc8dd2071449808088->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder59d0fc8dd2071449808088;
    ...
    {
        $this->initializer59d0fc8dd2084142875769 && $this->initializer59d0fc8dd2084142875769->__invoke($this->valueHolder59d0fc8dd2071449808088, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer59d0fc8dd2084142875769);
    ...
    {
        $this->initializer59d0fc8dd2084142875769 && $this->initializer59d0fc8dd2084142875769->__invoke($this->valueHolder59d0fc8dd2071449808088, $this, '__isset', array('name' => $name), $this->initializer59d0fc8dd2084142875769);
    ...
    {
        $this->initializer59d0fc8dd2084142875769 && $this->initializer59d0fc8dd2084142875769->__invoke($this->valueHolder59d0fc8dd2071449808088, $this, '__unset', array('name' => $name), $this->initializer59d0fc8dd2084142875769);
    ...
    {
        $this->initializer59d0fc8dd2084142875769 && $this->initializer59d0fc8dd2084142875769->__invoke($this->valueHolder59d0fc8dd2071449808088, $this, '__clone', array(), $this->initializer59d0fc8dd2084142875769);

        $this->valueHolder59d0fc8dd2071449808088 = clone $this->valueHolder59d0fc8dd2071449808088;
    }

    public function __sleep()
    {
        $this->initializer59d0fc8dd2084142875769 && $this->initializer59d0fc8dd2084142875769->__invoke($this->valueHolder59d0fc8dd2071449808088, $this, '__sleep', array(), $this->initializer59d0fc8dd2084142875769);

        return array('valueHolder59d0fc8dd2071449808088');
    }
    ...
    {
        return $this->initializer59d0fc8dd2084142875769;
    }
    ...
    {
        return $this->initializer59d0fc8dd2084142875769 && $this->initializer59d0fc8dd2084142875769->__invoke($this->valueHolder59d0fc8dd2071449808088, $this, 'initializeProxy', array(), $this->initializer59d0fc8dd2084142875769);
    }
    ...
    {
        return null !== $this->valueHolder59d0fc8dd2071449808088;
    }
    ...
    {
        return $this->valueHolder59d0fc8dd2071449808088;
    }
