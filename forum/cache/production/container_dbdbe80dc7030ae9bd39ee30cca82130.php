...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000018b9afbd0000000023157af0(
...
class phpbbtemplatetwiglexer_0000000018b9afbd0000000023157af0 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder59d0fcaf102b2025302209 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer59d0fcaf102c8159392594 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties59d0fcaf10273646985895 = array(
    ...
    {
        $this->initializer59d0fcaf102c8159392594 && $this->initializer59d0fcaf102c8159392594->__invoke($this->valueHolder59d0fcaf102b2025302209, $this, 'set_environment', array('env' => $env), $this->initializer59d0fcaf102c8159392594);

        return $this->valueHolder59d0fcaf102b2025302209->set_environment($env);
    }
    ...
    {
        $this->initializer59d0fcaf102c8159392594 && $this->initializer59d0fcaf102c8159392594->__invoke($this->valueHolder59d0fcaf102b2025302209, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer59d0fcaf102c8159392594);

        return $this->valueHolder59d0fcaf102b2025302209->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer59d0fcaf102c8159392594 && $this->initializer59d0fcaf102c8159392594->__invoke($this->valueHolder59d0fcaf102b2025302209, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer59d0fcaf102c8159392594);

        return $this->valueHolder59d0fcaf102b2025302209->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer59d0fcaf102c8159392594 = $initializer;
    }
    ...
    {
        $this->initializer59d0fcaf102c8159392594 && $this->initializer59d0fcaf102c8159392594->__invoke($this->valueHolder59d0fcaf102b2025302209, $this, '__get', array('name' => $name), $this->initializer59d0fcaf102c8159392594);

        if (isset(self::$publicProperties59d0fcaf10273646985895[$name])) {
            return $this->valueHolder59d0fcaf102b2025302209->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder59d0fcaf102b2025302209;
    ...
    {
        $this->initializer59d0fcaf102c8159392594 && $this->initializer59d0fcaf102c8159392594->__invoke($this->valueHolder59d0fcaf102b2025302209, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer59d0fcaf102c8159392594);
    ...
    {
        $this->initializer59d0fcaf102c8159392594 && $this->initializer59d0fcaf102c8159392594->__invoke($this->valueHolder59d0fcaf102b2025302209, $this, '__isset', array('name' => $name), $this->initializer59d0fcaf102c8159392594);
    ...
    {
        $this->initializer59d0fcaf102c8159392594 && $this->initializer59d0fcaf102c8159392594->__invoke($this->valueHolder59d0fcaf102b2025302209, $this, '__unset', array('name' => $name), $this->initializer59d0fcaf102c8159392594);
    ...
    {
        $this->initializer59d0fcaf102c8159392594 && $this->initializer59d0fcaf102c8159392594->__invoke($this->valueHolder59d0fcaf102b2025302209, $this, '__clone', array(), $this->initializer59d0fcaf102c8159392594);

        $this->valueHolder59d0fcaf102b2025302209 = clone $this->valueHolder59d0fcaf102b2025302209;
    }

    public function __sleep()
    {
        $this->initializer59d0fcaf102c8159392594 && $this->initializer59d0fcaf102c8159392594->__invoke($this->valueHolder59d0fcaf102b2025302209, $this, '__sleep', array(), $this->initializer59d0fcaf102c8159392594);

        return array('valueHolder59d0fcaf102b2025302209');
    }
    ...
    {
        return $this->initializer59d0fcaf102c8159392594;
    }
    ...
    {
        return $this->initializer59d0fcaf102c8159392594 && $this->initializer59d0fcaf102c8159392594->__invoke($this->valueHolder59d0fcaf102b2025302209, $this, 'initializeProxy', array(), $this->initializer59d0fcaf102c8159392594);
    }
    ...
    {
        return null !== $this->valueHolder59d0fcaf102b2025302209;
    }
    ...
    {
        return $this->valueHolder59d0fcaf102b2025302209;
    }
